        ...
        <CardContent className="grid grid-cols-2 md:grid-cols-6 gap-4">
          ...
          <div>
            ...
            <select
              ...
              className="w-full h-10 px-3 py-2 rounded-xl border border-border bg-card text-foreground transition-colors focus:outline-none focus:ring-2 focus:ring-ring"
            >
          ...
          <div className="flex flex-col sm:flex-row gap-4 items-start sm:items-center justify-between">
            <div className="flex-1 max-w-md">
              ...
              <div className="flex gap-2">
                ...
                />
                <Button onClick={handleNominalUpdate} variant="default" className="h-10">
                  Simpan
                </Button>
              </div>
            </div>
      ...
      <Card className="border-0 shadow-sm">
        <CardHeader className="pb-4">
          ...
          <p className="text-sm text-muted-foreground mt-1">
            Centang kotak untuk mencatat pembayaran
          </p>
        </CardHeader>
                ...
                <TableHead className="font-semibold sticky left-0 bg-secondary/30 z-10 min-w-[200px]">
                  <div className="flex items-center justify-between gap-2">
                    ...
                    <button
                      ...
                      className="text-xs bg-primary/10 hover:bg-primary/20 px-2 py-1 rounded-lg transition-colors font-medium"
